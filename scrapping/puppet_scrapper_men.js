...
class AldoScraper {
    constructor() {
        this.baseUrl = 'https://www.aldoshoes.com/en-ca/collections/mens';
        this.products = [];
    ...
    async saveResults() {
        const outputFile = path.join(__dirname, 'aldo_mens_products.json');
    ...
    async run() {
        try {
            console.log('🚀 Starting Aldo scraper...');
            await this.init();
